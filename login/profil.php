      ...
      <div class="content">
        <table class="profil-table">
          <tr>
            ...
            <td class="login-in" style="width:200px;"><?php echo $data['iduser']; ?></td>
          <tr>
            <td>Nama Lengkap</td>
            <td class="login-in"><?php echo $data['namalengkap']; ?></td>
          </tr>
          <tr>
            <td>Jenis Kelamin</td>
            <td class="login-in"><?php echo $data['jeniskelamin']; ?></td>
          </tr>
        </table>
